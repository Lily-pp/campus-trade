<template>
  <div class="lost-found-page">
    ...
    <div class="action-bar">
      <el-radio-group v-model="activeTab" @change="loadData" size="default">
        <el-radio-button value="found">招领信息</el-radio-button>
        <el-radio-button value="lost">丢失信息</el-radio-button>
      </el-radio-group>

      <div class="right-actions">
        <el-button type="success" plain @click="openSearchMap">
          {{ searchAddress ? '重新设置搜索位置' : '设置搜索位置' }}
       </el-button>
       ...
       >
        ...
        <el-button type="primary" :icon="Plus" @click="showPublish = true">
          发布{{ activeTab === 'found' ? '招领' : '丢失' }}信息
        </el-button>
      </div>
    </div>

    <div v-if="searchAddress" style="margin: 8px 0 12px; font-size: 13px; color: #67c23a;">
      当前搜索中心：{{ searchAddress }}
      <el-button type="text" size="small" @click="clearSearchLocation">清除</el-button>
    </div>
